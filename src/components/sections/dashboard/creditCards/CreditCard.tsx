...
const getThemeStyles = (theme: 'blue' | 'white' | 'black', palette: Palette) => {
  switch (theme) {
    case 'blue':
      return {
    ...
    case 'black':
      return {
        cardBg: palette.common.black,
        textColor: palette.common.white,
        labelColor: palette.grey[500],
        chipCard: ChipCardWhite,
        bankLogo: BankLogo,
        cardGradient: 'linear-gradient(to bottom, #000000, #333333)',
        borderStyle: 1,
      };
    default:
      return {
